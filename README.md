...
If used styles or scripts would be included in the output html file.
...
## Release History
- 0.3.4 Update [node-htmlprocessor](https://github.com/dciccale/node-htmlprocessor) dependency with `inline` modifier
